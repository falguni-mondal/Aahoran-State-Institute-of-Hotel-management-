...
const FacilityCard = ({ facility }) => {
  ...
  return (
    ...
    <Link
      to={facility.link}
      ref={cardRef}
      className={`group w-full flex flex-col p-5 md:p-6 lg:p-8 xl:p-10 border-r border-b border-[var(--primary-base)]/15 bg-transparent cursor-pointer outline-none ${facility.gridClass}`}
    >
      <div 
        ref={imgWrapperRef}
      ...
      <div className="flex flex-row items-end justify-between w-full mt-auto">
        <div className="flex flex-col items-start">
          ...
          <h3 className="head-txt text-2xl md:text-3xl lg:text-[2rem] xl:text-[2.25rem] text-[var(--primary-base)] leading-tight tracking-tight drop-shadow-none group-hover:text-[var(--accent)] transition-colors duration-500">
            {facility.title}
          </h3>
        </div>
