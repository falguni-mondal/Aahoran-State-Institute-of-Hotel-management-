...
export default function Hero() {
  ...
  useGSAP(
    () => {
      ...
      // The Premium Text & Video Reveal (Masked Stagger)
      tl.fromTo(
        ".hero-title-line",
        { y: "110%" },
  ...
  return (
    ...
    >
      {/* Background Video - Opacity reduced drastically to reduce visual busyness */}
      <video
      ...
      {/* Darkening Overlay - Opacity increased to 95% for a stronger, solid base */}
