          ...
          <div className="flex flex-col border-t border-[var(--primary-base)]/15">
            ...
            {generalRules.map((rule, index) => {
              ...
              return (
                <div 
                  key={index} 
                  className="rule-item group relative flex flex-col md:flex-row border-b border-[var(--primary-base)]/15 py-12 md:py-16 lg:py-20 transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] opacity-30 [&.is-active]:opacity-100"
                >
