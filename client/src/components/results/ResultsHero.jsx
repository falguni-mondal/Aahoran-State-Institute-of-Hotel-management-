...
export default function ResultsHero() {
  ...
  useGSAP(() => {
    ...
    mm.add("(min-width: 320px)", () => {
      ...
      // 2. Text Elements Fade & Drift Up (Staggered Split-Line)
      .fromTo('.hero-sub',
        { y: 30, opacity: 0 },
      ...
      .fromTo('.hero-title-line',
        { y: 60, opacity: 0, rotateX: -15 }, // Adds a subtle 3D flip-up effect
        { y: 0, opacity: 1, rotateX: 0, duration: 1.5, stagger: 0.15, ease: 'power3.out' },
        "-=1.8"
      )
  ...
  return (
    ...
    >
      ...
      <div className="hero-img-wrapper absolute inset-0 w-full h-full z-0 overflow-hidden">
        <img 
          src="/results_hero.webp" 
          alt="Academic Records Archive" 
          className="hero-bg-img absolute top-[-10%] left-0 w-full h-[120%] object-cover origin-center"
        />
        {/* Dark Overlay for Text Legibility (Slightly darker for the bright text) */}
