        ...
        */}
        <div className="hidden md:flex md:w-1/3 bg-[var(--accent)] p-8 flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="font-sans text-xs text-[var(--text-light)]/80 leading-relaxed">
        ...
        <div className="w-full md:w-2/3 px-8 p-12 relative max-h-[90vh] overflow-y-auto custom-scrollbar">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-8" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="col-span-1 md:col-span-2 mt-4 flex justify-end">
              <button type="submit" className="bg-[var(--accent)] text-[var(--text-light)] px-8 py-3 font-sans font-bold text-sm uppercase tracking-widest hover:bg-[#FF8C42] transition-colors duration-300 shadow-lg cursor-pointer">
                Submit Query
              </button>
            </div>
          </form>
