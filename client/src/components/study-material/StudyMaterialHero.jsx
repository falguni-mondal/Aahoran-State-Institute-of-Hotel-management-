...
export default function StudyMaterialHero() {
  ...
  return (
    <section 
      ref={sectionRef} 
      className="hero-section relative w-full h-[100dvh] min-h-[600px] flex flex-col justify-end overflow-hidden pb-12 md:pb-16 lg:pb-24 bg-[var(--background)] text-[var(--text-main)]"
    >
      ...
      <div className="relative z-10 w-full px-5 md:px-8 lg:px-12 xl:px-16 2xl:px-24 mx-auto max-w-[1800px] flex flex-col h-full pt-32 lg:pt-40">
        ...
        <div className="flex flex-col w-full my-auto lg:mt-auto lg:mb-0 pb-12 lg:pb-0">
          ...
          {/* Missing Paragraph Added Here */}
          <div className="overflow-hidden w-full flex justify-center md:justify-end mt-6 md:mt-8 pr-0 md:pr-12 lg:pr-24">
             <p className="hero-sub text-sm md:text-base lg:text-lg font-light text-[var(--text-main)]/60 max-w-md text-center md:text-right">
               Curated digital resources, essential study guides, and academic reference materials to support your learning journey.
             </p>
          </div>
        </div>
